...
unsigned int KeyChecker::F(unsigned int X, unsigned int Y, unsigned int Z) { return ((X & Y) | ((~X) & Z)); }
unsigned int KeyChecker::G(unsigned int X, unsigned int Y, unsigned int Z) { return (X & Z) | (Y & (~Z)); }
unsigned int KeyChecker::H(unsigned int X, unsigned int Y, unsigned int Z) { return X ^ Y^ Z; }
unsigned int KeyChecker::I(unsigned int X, unsigned int Y, unsigned int Z) { return Y ^ (X | (~Z)); }
unsigned int KeyChecker::rotate_left(unsigned int value, int shift) { return value << shift | value >> (32 - shift); }
